"""R1 v0.669 successor; resumes the confirmed provisioning checkpoint."""
...
EXECUTION_CONFIRMATION = (
    "REANUDAR NIA-NEXT R1 V0669 DESDE CHECKPOINT SIN GET NI PUT"
)
REPORT_RELATIVE = Path(".tmp/r1_integral_product_v0669_latest.json")
...
def _sanitized(snapshot) -> dict:
    ...
    allowlist = {
        ...
        "session_state", "restoration_state", "failure_stage",
        "failure_category", "external_retries",
    }
