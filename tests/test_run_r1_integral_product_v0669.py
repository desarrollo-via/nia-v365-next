...
from scripts import run_r1_integral_product_v0669 as launcher


class RunR1IntegralProductV0669Tests(unittest.TestCase):
    ...
    def test_confirmation_literal_and_budgets_are_frozen(self):
        ...
        self.assertEqual(
            launcher.REPORT_RELATIVE.as_posix(),
            ".tmp/r1_integral_product_v0669_latest.json",
        )
